...
SUDO = SUDO
sudo_users = {SUDO,1754239041,1033028167}   
print([[
> CH › @GVVVV6
> CH › @Bw5Bw
~> DEVELOPER › @lMlMMM
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LanZoxTeaM/File_LANZO/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/LanZoxTeaM/LanZo/main/LanZo.lua')
...
local url,res = https.request('https://vvvzvv.ml/RAVEN/LanZo.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'✫︙شترك في قناة السورس اولآ @Bw5Bw .')
return false
end
...
if DevLanZoW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LanZoxTeaM/File_LANZO/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LanZoxTeaM/File_LANZO/main/File_Bot/"..file)
if res == 200 then
...
{{text = 'LanZoxTeaM', url="t.me/Bw5Bw"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
