...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LANZO-DEV/File_LANZO/main/File_Bot/commands.lua") 
...
if not DevLANZOW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
local LANZO1_Msg = database:get(bot_id.."LANZO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if LANZO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
local LANZO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if LANZO_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevLANZOW(msg) then
...
database:sadd(bot_id.."LANZO:blocname"..msg.chat_id_, BlNe)
end
...
database:srem(bot_id.."LANZO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
...
if DevLANZOW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LANZO-DEV/File_LANZO/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LANZO-DEV/File_LANZO/main/File_Bot/"..file)
if res == 200 then
...
database:set(bot_id.."LANZO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."LANZO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✫︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."LANZO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."LANZO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."LANZO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."LANZO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✫︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."LANZO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."LANZO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."LANZO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."LANZO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✫︙ارسل الكلمه الان*")  
database:set(bot_id.."LANZO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."LANZO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."LANZO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LANZO1:Add:Filter:Rp2"..text..msg.chat_id_)  
...
for k,v in pairs(list) do  
database:del(bot_id.."LANZO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LANZO1:Add:Filter:Rp2"..v..msg.chat_id_)  
...
if database:get(bot_id..'Bc:Bots') and not DevLANZOW(msg) then 
...
send(msg.chat_id_, msg.id_, t..'ٴ✫∫ٴ*•━━━━━━ 𝗟𝗼 ━━━━━━━•*ٴ✫∫○ٴ\n✫︙[𝘙𝘈𝘝𝘌𝘕 𝘛𝘌𝘈𝘔](t.me/Bw5Bw) ')
end
...
------------------------------------------------------------------------
local LANZOAbot = database:get(bot_id.."LANZO1:Add:Filter:Rp2"..text..result.chat_id_)   
if LANZOAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫︙["..LANZOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local LANZO1_Msg = database:get(bot_id.."LANZO1:Add:Filter:Rp2"..text..result.chat_id_)   
if LANZO1_Msg then
