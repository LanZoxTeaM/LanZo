...
io.popen("cd library && wget https://raw.githubusercontent.com/LanZoxTeaM/LanZo/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LanZoxTeaM/Files_LANZO/main/File_Bot/commands.lua") 
...
local url,res = https.request('https://vvvzvv.ml/apiLanZo/LanZo.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
...
if DevLanZoW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LanZoxTeaM/Files_LANZO/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LanZoxTeaM/Files_LANZO/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,LanZo)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
x = 0
...
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/Bw5Bw"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://vvvzvv.ml/amirZhfa/LanZo.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ 𝗧𝗘 ━━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
gk = https.request('https://vvvzvv.ml/amirBrg/LanZo.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/LanZo.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/LanZo.php')
if res == 200 then
...
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/Bw5Bw'}},
}
